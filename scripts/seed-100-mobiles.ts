...
async function main() {
  console.log("🌱 Starting to add 100 latest mobile products to database...");

  // 1. Get or create Smartphones category
  ...
  if (!category) {
    category = await prisma.category.create({
      data: {
        ...
        icon: "Smartphone",
        image: "https://cdn.abacus.ai/images/43fe3e39-178b-4a6a-96ea-8ff350f5c434.png"
      }
    });
  ...
  // 2. Define the 100 mobile products
  const mobileModels = [
    // --- APPLE (10 models) ---
    {
    ...
    },
    {
      ...
      image: "https://m.media-amazon.com/images/I/71Yy8+cW1NL._SX679_.jpg", // Fallback
    ...
    },
    {
      ...
      price: 54999,
      originalPrice: 59999,
      image: "https://m.media-amazon.com/images/I/71KdLNkiZtL._SX679_.jpg", // Fallback
    ...
    },
    {
      ...
      price: 23999,
      originalPrice: 25999,
      image: "https://m.media-amazon.com/images/I/71v4u21hD5L._SX679_.jpg", // Fallback
    ...
    },
    {
      ...
      price: 89999,
      originalPrice: 96999,
      image: "https://m.media-amazon.com/images/I/71dEc4jD-9L._SX679_.jpg", // Fallback
    ...
    },
    {
      ...
      price: 94999,
      originalPrice: 99999,
      image: "https://m.media-amazon.com/images/I/81xUu8S5JpL._SX679_.jpg", // Fallback
  ...
  // Helper function to generate unique slugs and set other product properties
  console.log(`Prepared ${mobileModels.length} product templates...`);
  ...
  for (const model of mobileModels) {
    ...
    const stock = Math.floor(Math.random() * 40) + 15; // 15 to 55
    const rating = Number((Math.random() * (4.9 - 4.1) + 4.1).toFixed(1)); // 4.1 to 4.9
    const reviewCount = Math.floor(Math.random() * 300) + 20; // 20 to 320
    const featured = Math.random() > 0.7; // 30% are featured
    const trending = Math.random() > 0.6; // 40% are trending
    ...
    count++;
    if (count % 10 === 0) {
      console.log(`... Added/Updated ${count} products`);
    }
  }

  console.log(`🌱 Completed seeding database. Added/Updated ${count} mobile products!`);
}
